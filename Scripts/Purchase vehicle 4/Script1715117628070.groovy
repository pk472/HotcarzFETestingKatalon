...
WebUI.click(findTestObject('Object Repository/Page_Hot Carz Dealership/button_Customers'))

WebUI.click(findTestObject('Object Repository/Page_Hot Carz Dealership/button_View Financial'))

WebUI.click(findTestObject('Object Repository/Page_Hot Carz Dealership/span_'))
